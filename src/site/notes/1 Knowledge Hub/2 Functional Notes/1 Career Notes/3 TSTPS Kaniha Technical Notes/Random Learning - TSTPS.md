---
{"dg-publish":true,"permalink":"/1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/Random Learning - TSTPS/","noteIcon":""}
---
...
- **To put MDBFP & TDBFP in auto**
    - after loading TDBFP , make sure both suction flow maintaining around same value then put TDBFP remote permissive ok, then put TD in auto, later put MD scoop in auto. now you can give SP from FW station in manual. [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/A Protection Interlocks and Control Logic Systems/Pni\|Pni]]
- All Mills have VFD except Mill-A unit-1
- - **LPBP protection checking**
    - [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/LPBP\|1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/LPBP]] tripping on spray water pr low is in switch 
- - [[Service air pressure\|Service air pressure]]
    - goes to only GGG, APH air motors and now atomizing of LDO. & instrument air to only valve operation
- Unit 2 [[Overhauling\|Overhauling]] around 9200 joints in 2022
- - •While putting[[ TG in barring\| TG in barring]]
...
- - [[MFT\|MFT]] [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/A Protection Interlocks and Control Logic Systems/Pni\|Pni]]
    - If BLI > 65%,
        - One BFP 20sec
    - If BLI < 65%
        - No BFP 10sec
- 415V [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/3 Electrical Systems/UPS\|UPS]] supply taken from USS-A and USS-B, UPS-1 and UPS-2 #pending 
- Stress limit is at 60%, if it goes below 60% can load further [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/2 Main TG and Auxillaries/Main TG rolling\|Main TG rolling]]
- during [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/2 Main TG and Auxillaries/Main TG rolling\|Main TG rolling]] At 1900rpm, to some rpm HPTs critical speed, so only IPCV will be used for increasing speed of Turbine #pending 
- [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/A Protection Interlocks and Control Logic Systems/CLCS/Main TG\|Main TG]] overspeed exact rules #pending 
...
- Oil injection in [[TDBFP overspeed test\|TDBFP overspeed test]]  #pending - how is it similar to [[safety valve lifting\|safety valve lifting]] or trevy setting
- [[- HP Bypass\|- HP Bypass]] #pending 
- [[- LP Bypass\|- LP Bypass]] #pending 
- AFT Spray is from  service water and clarified water
- Passivation of boiler at 12ksc, after or during [[Overhauling\|Overhauling]] #pending 
- After [[Overhauling\|Overhauling]]they trip unit on RH protection [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/A Protection Interlocks and Control Logic Systems/Pni\|Pni]] logic why is it so?? #pending 
	*this is for checking*
- 100% [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/A Protection Interlocks and Control Logic Systems/BMCR\|BMCR]] is 560MW as mentioned in CLCS document
- [[BID\|BID]] 0-100% = 0-600MW, mentioned in CLCS document
-  I think #pending [[BLI\|BLI]] is nothing but steam flow, as mentioned in ST-1 Pni document for SDCS
- As per scheme [[1 Knowledge Hub/2 Functional Notes/1 Career Notes/3 TSTPS Kaniha Technical Notes/7 Other Systems Notes/FG VAM\|FG VAM]] AC CT make up is from clarified(main) and service water(alternate), but when clarified is not available, Service water makeup will not be sufficint, so temporary tapping available taken from Fire hydrant
...
- **MDBFP suction became steam** recent flushing of boiler with MDBFP running and draining from separator, MDBFP tripped with sound from booster pump and suction flow and pressure got drastically decreased,
	...
	- of course incidentally, MDBFP suction strainer also found to have with lot of waste(resin- that's [[1 Knowledge Hub/3 Library/D Experiences & Learnings/1 Office/2 TSTPS Incidents & Experiences/Unit stopping due to ACC high\|Unit stopping due to ACC high]] story)
...
- In recent this resin passing- [[1 Knowledge Hub/3 Library/D Experiences & Learnings/1 Office/2 TSTPS Incidents & Experiences/Unit stopping due to ACC high\|Unit stopping due to ACC high]], after overhauling they did not remove the commisioning strainer in two CEPs and one TDBFP, both CEPs got choked while unit running, but TDBFP didn't get choke, I suspected why, after this [[1 Knowledge Hub/3 Library/D Experiences & Learnings/1 Office/2 TSTPS Incidents & Experiences/Unit stopping due to ACC high\|Unit stopping due to ACC high]], checked and found tthat it's suction strainer got damaged that is there is a big hole in strainer, leading to passing of wtaer freely, it seems that it got so much choked and so got burst open makin hole in strainer
...
- **VACCUM IN STAGE-1**
- ![p4j4STu.png](/img/user/Obsidian%20Functional%20Stuff/z-All%20pdfs,%20Images%20&%20Small%20Excalidraws/p4j4STu.png)
